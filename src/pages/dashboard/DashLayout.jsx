      ...
      >
        ...
        <Box sx={{ overflow: "auto" }}>
              ...
              <ListItemIcon>
                <SvgIcon>
                  <svg
                    ...
                    fill="none"
                  >
                    <g clip-path="url(#clip0_78276_635)">
                      <path
                        opacity="0.4"
          ...
          <List
            ...
            subheader={<ListSubheader>CUSTOMERS</ListSubheader>}
          >
            <ListItemButton
            ...
            <ListItemButton>
              ...
              <ListItemText>Guarantors</ListItemText>
            </ListItemButton>
            <ListItemButton>
              <ListItemIcon>
                <SvgIcon>
                  <svg
                    ...
                    fill="none"
                  >
                    <g clip-path="url(#clip0_78276_818)">
                      <path
                        opacity="0.4"
              ...
              <ListItemText>Loans</ListItemText>
            </ListItemButton>
            <ListItemButton>
              <ListItemIcon>
                <SvgIcon>
              ...
              <ListItemText>Decision Models</ListItemText>
            </ListItemButton>
            <ListItemButton>
              <ListItemIcon>
                <SvgIcon>
                  <svg
                    ...
                    fill="none"
                  >
                    <g clip-path="url(#clip0_78276_796)">
                      <path
                        opacity="0.4"
            ...
            <ListItemButton>
              <ListItemIcon>
                <SvgIcon>
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <g clip-path="url(#clip0_78276_805)">
                      <path
                    ...
                    <g clip-path="url(#clip1_78276_805)">
                      <path
                        opacity="0.4"
              ...
              <ListItemText>Loan Requests</ListItemText>
            </ListItemButton>
            <ListItemButton>
              <ListItemIcon>
                <SvgIcon>
                  <svg
                    ...
                    fill="none"
                  >
                    <g clip-path="url(#clip0_78276_836)">
                      <path
                        opacity="0.4"
              ...
              <ListItemIcon>
                <SvgIcon>
                  <svg
                    ...
                    fill="none"
                  >
                    <g clip-path="url(#clip0_78276_845)">
                      <path
                        opacity="0.4"
          ...
          <List
            component="nav"
            aria-labelledby="nested-list-subheader"
            subheader={<ListSubheader>BUSINESSES</ListSubheader>}
          >
            <ListItemButton>
              <ListItemIcon>
                <SvgIcon>
            ...
            <ListItemButton>
              ...
              <ListItemText>Loan Products</ListItemText>
            </ListItemButton>
            <ListItemButton>
              <ListItemIcon>
                <SvgIcon>
              ...
              <ListItemText>Savings Products </ListItemText>
            </ListItemButton>
            <ListItemButton>
              <ListItemIcon>
                <SvgIcon>
                  <svg
                    ...
                    fill="none"
                  >
                    <g clip-path="url(#clip0_78276_749)">
                      <path
              ...
              <ListItemText>Fees and Charges </ListItemText>
            </ListItemButton>
            <ListItemButton>
              <ListItemIcon>
                <SvgIcon>
              ...
              <ListItemIcon>
                <SvgIcon>
                  <svg
                    ...
                    fill="none"
                  >
                    <g clip-path="url(#clip0_78276_719)">
                      <path
                        opacity="0.4"
            ...
            <ListItemButton>
              ...
              <ListItemText>Service Account </ListItemText>
            </ListItemButton>
            <ListItemButton>
              <ListItemIcon>
                <SvgIcon>
                  <svg
                    ...
                    fill="none"
                  >
                    <g clip-path="url(#clip0_78276_709)">
                      <path
                        opacity="0.4"
          ...
          >
              ...
              <ListItemIcon>
                <SvgIcon>
                  <svg
                    ...
                    fill="none"
                  >
                    <g clip-path="url(#clip0_78276_690)">
                      <path
                        opacity="0.4"
            ...
            <ListItemButton>
              <ListItemIcon>
                <SvgIcon>
                  <svg
                    ...
                    fill="none"
                  >
                    <g clip-path="url(#clip0_78276_670)">
                      <path
                        opacity="0.4"
                        d="M16 8.00004C16.0001 7.44023 15.8292 6.89374 15.5104 6.43361C15.1915 5.97348 14.7398 5.62162 14.2157 5.42504C14.4469 4.91554 14.5172 4.34763 14.4172 3.79713C14.3172 3.24662 14.0516 2.73972 13.656 2.34408C13.2604 1.94845 12.7535 1.68291 12.203 1.58291C11.6525 1.48291 11.0845 1.5532 10.575 1.78442C10.3785 1.2602 10.0267 0.808446 9.56654 0.489537C9.1064 0.170628 8.55989 -0.000244141 8.00004 -0.000244141C7.4402 -0.000244141 6.89368 0.170628 6.43355 0.489537C5.97341 0.808446 5.62157 1.2602 5.42504 1.78442C4.91554 1.5532 4.34763 1.48291 3.79713 1.58291C3.24662 1.68291 2.73972 1.94845 2.34408 2.34408C1.94845 2.73972 1.68291 3.24662 1.58291 3.79713C1.48291 4.34763 1.5532 4.91554 1.78442 5.42504C1.2602 5.62157 0.808446 5.97341 0.489537 6.43355C0.170628 6.89368 -0.000244141 7.4402 -0.000244141 8.00004C-0.000244141 8.55989 0.170628 9.1064 0.489537 9.56654C0.808446 10.0267 1.2602 10.3785 1.78442 10.575C1.5532 11.0845 1.48291 11.6525 1.58291 12.203C1.68291 12.7535 1.94845 13.2604 2.34408 13.656C2.73972 14.0516 3.24662 14.3172 3.79713 14.4172C4.34763 14.5172 4.91554 14.4469 5.42504 14.2157C5.62157 14.7399 5.97341 15.1916 6.43355 15.5106C6.89368 15.8295 7.4402 16.0003 8.00004 16.0003C8.55989 16.0003 9.1064 15.8295 9.56654 15.5106C10.0267 15.1916 10.3785 14.7399 10.575 14.2157C11.0845 14.4469 11.6525 14.5172 12.203 14.4172C12.7535 14.3172 13.2604 14.0516 13.656 13.656C14.0516 13.2604 14.3172 12.7535 14.4172 12.203C14.5172 11.6525 14.4469 11.0845 14.2157 10.575C14.7398 10.3785 15.1915 10.0266 15.5104 9.56648C15.8292 9.10634 16.0001 8.55986 16 8.00004ZM6.00004 5.00004C6.19783 5.00004 6.39117 5.05869 6.55561 5.16857C6.72006 5.27846 6.84824 5.43464 6.92392 5.61736C6.99961 5.80009 7.01941 6.00115 6.98083 6.19513C6.94224 6.38912 6.847 6.5673 6.70715 6.70715C6.5673 6.847 6.38912 6.94224 6.19513 6.98083C6.00115 7.01941 5.80009 6.99961 5.61736 6.92392C5.43464 6.84824 5.27846 6.72006 5.16857 6.55561C5.05869 6.39117 5.00004 6.19783 5.00004 6.00004C5.00004 5.73483 5.1054 5.48047 5.29294 5.29294C5.48047 5.1054 5.73483 5.00004 6.00004 5.00004ZM6.38379 10.6766C6.33736 10.723 6.28224 10.7599 6.22157 10.785C6.1609 10.8102 6.09587 10.8231 6.0302 10.8231C5.96453 10.8231 5.8995 10.8102 5.83883 10.785C5.77816 10.7599 5.72304 10.723 5.67661 10.6766L5.32317 10.3232C5.27673 10.2767 5.23989 10.2216 5.21475 10.1609C5.18962 10.1003 5.17668 10.0352 5.17668 9.96957C5.17668 9.9039 5.18962 9.83888 5.21475 9.77821C5.23989 9.71754 5.27673 9.66241 5.32317 9.61598L9.61598 5.32317C9.66241 5.27673 9.71754 5.23989 9.77821 5.21475C9.83888 5.18962 9.9039 5.17668 9.96957 5.17668C10.0352 5.17668 10.1003 5.18962 10.1609 5.21475C10.2216 5.23989 10.2767 5.27673 10.3232 5.32317L10.6766 5.67661C10.723 5.72304 10.7599 5.77816 10.785 5.83883C10.8102 5.8995 10.8231 5.96453 10.8231 6.0302C10.8231 6.09587 10.8102 6.1609 10.785 6.22157C10.7599 6.28224 10.723 6.33736 10.6766 6.38379L6.38379 10.6766ZM10 11C9.80226 11 9.60892 10.9414 9.44447 10.8315C9.28002 10.7216 9.15185 10.5655 9.07616 10.3827C9.00048 10.2 8.98067 9.99893 9.01926 9.80495C9.05784 9.61097 9.15308 9.43279 9.29294 9.29294C9.43279 9.15308 9.61097 9.05784 9.80495 9.01926C9.99893 8.98067 10.2 9.00048 10.3827 9.07616C10.5655 9.15185 10.7216 9.28002 10.8315 9.44447C10.9414 9.60892 11 9.80226 11 10C11 10.2653 10.8947 10.5196 10.7072 10.7072C10.5196 10.8947 10.2653 11 10 11Z"
                        fill="#213F7D"
                      />
                      <path
              ...
              <ListItemText>Fees and Pricing</ListItemText>
            </ListItemButton>
            <ListItemButton>
              <ListItemIcon>
                <SvgIcon>
                  <svg
                    ...
                    fill="none"
                  >
                    <g clip-path="url(#clip0_78276_680)">
                      <path
                        opacity="0.4"
